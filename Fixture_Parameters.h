...
constexpr int milli_amps = 140000;		// Maximum power output of the connected power supply. Setting this properly will prevent brown outs!
...
{
	{21,	288,	144,	_s_Linear,	288,	1},
	{19,	288,	144,	_s_Linear,	288,	1},
	{18,	288,	144,	_s_Linear,	288,	1},
	{15,	288,	144,	_s_Linear,	288,	1},
	{2,		288,	144,	_s_Linear,	288,	1},
	{0,		288,	144,	_s_Linear,	288,	1},
	{4,		288,	144,	_s_Linear,	288,	1},
	{5,		288,	144,	_s_Linear,	288,	1}
};
